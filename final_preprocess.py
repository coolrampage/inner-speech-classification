...
wordorder = []
with open(r"C:\Users\vaibh\Downloads\Neuro\Events and Timings\sub-05_ses-EEG_task-inner_events.txt", "r") as x:
    for line in x:
        store = line.split()
...
# Load EEG data
#raw = mne.io.read_raw_bdf(r"C:\Users\vaibh\Downloads\Neuro\Events and Timings\sub-01_ses-EEG_task-inner_eeg (1).bdf", preload=True)
raw = mne.io.read_raw_bdf(r"C:\Users\vaibh\Downloads\Neuro\Events and Timings\sub-05_ses-EEG_eeg.bdf", preload=True)
...
np.save(r'C:\Users\vaibh\Downloads\Neuro\Data\np5.npy', denoised_data)

labels = events[:, 2]

# Save the labels to a file
np.save(r'C:\Users\vaibh\Downloads\Neuro\Data\labels5.npy', labels) 
